...
Use an alternate I<command> instead of
L<pkgadd(8)|https://github.com/zeppe-lin/zeppe-lin/blob/master/core/pkgutils/blob/master/pkgadd.8.pod>
...
Use an alternate I<command> instead of
L<pkgrm(8)|https://github.com/zeppe-lin/zeppe-lin/blob/master/core/pkgutils/blob/master/pkgrm.8.pod>
...
Use an alternate command instead of L<sh(1)> for the command which is
