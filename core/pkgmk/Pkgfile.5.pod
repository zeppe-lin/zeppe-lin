...
file is a L<sh(1)|https://www.mankier.com/1/sh> script, which defines
a number of variables (I<name>, I<version>, I<release> and I<source>)
and a function (I<build>) that should be executed in order to compile
a package.
...
L<pkgman-rdep(1)|https://github.com/zeppe-lin/zeppe-lin/blob/master/core/pkgman/pkgman-rdep.1.pod>).
