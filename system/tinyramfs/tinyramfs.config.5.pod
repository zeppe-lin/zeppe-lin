...
discovering via F</proc/mounts>.  This option must be specified if
you booted from Live CD.
...
L<tinyramfs.hooks(7)|https://github.com/zeppe-lin/zeppe-lin/blob/master/system/tinyramfs/tinyramfs.hooks.7.pod>.
