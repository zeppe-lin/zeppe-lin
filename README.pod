...
=head3 Download rootfs tarball
  ...
  # wget -c https://github.com/zeppe-lin/zeppe-lin/releases/download/\
    2022-07-04/rootfs-2022-07-04-x86_64.tar.xz{,.sig}

=head4 Signature verification

  # gpg --keyserver keyserver.ubuntu.com --recv-keys 59ec1986fbd902cf
  # gpg --verify rootfs-2022-07-04-x86_64.tar.xz.sig \
    rootfs-2022-07-04-x86_64.tar.xz

=head3 Extract rootfs tarball

  # tar -xvf rootfs-2022-07-04-x86_64.tar.xz -C .
...
B<mkinitramfs> and updates the grub config.  We turn off the execution
...
jump over the next paragraph, to the B<Install mkinitramfs>.
...
Add mkinitramfs' configuration file (F</etc/mkinitramfs/config>) with
